 ...
 * @author pasindu
 */
public final class RecoverFinal extends javax.swing.JFrame {
     ...
     */
    public RecoverFinal(Home homeFinal) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "RECOVER", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
        jPanel1.setPreferredSize(new java.awt.Dimension(1360, 768));

        jLabel2.setText("SELECT THE BACKUP FILE");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       ...
       try{
           ...
           final JOptionPane newOptionPane = new JOptionPane("Error(00064):Exception occured", JOptionPane.ERROR_MESSAGE);
        ...
        if(filePathTextField.getText().toString().isEmpty()){
            ...
            if(proceed == 0){
                    ...
                    if(serverPath == null || serverPath.isEmpty() || serverPath.equals("Server path has not been set")){
                        ...
                        String user = "root";
                        String password = "";
                        String[] restoreCmd = new String[]{serverPath + "/mysql.exe", "--user="+ user,"--password="+password, "-e", "source " +path };
                        ...
                        try{
                            ...
                            e.printStackTrace();
                            final JOptionPane newOptionPane = new JOptionPane("Error(00065):SQLException occured", JOptionPane.ERROR_MESSAGE);
                            final JDialog newDialog = newOptionPane.createDialog("Warning");
                            newDialog.setAlwaysOnTop(true);
                            newDialog.setVisible(true);
                        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecoverFinal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecoverFinal(homeFinal2).setVisible(true);
            }
        });
    }
